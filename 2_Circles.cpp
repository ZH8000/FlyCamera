...
const char* dist_circle = "minDist";
const char* par1_circle = "param 1";
const char* par2_circle = "param 2";
...
int RunSingleCamera( PGRGuid guid ) {
    ...
    while (true) {
        ...
        if (circleOnOff == 1) {
            ...
            namedWindow(win_circle, WINDOW_NORMAL);
            createTrackbar(dist_circle, win_circle, &circleMinDist, 300);
            createTrackbar(par1_circle, win_circle, &circleParam1, 300);
            createTrackbar(par2_circle, win_circle, &circleParam2, 300);
        } else {
            destroyWindow("detected circles");
            destroyWindow(win_circle);
        }
