...
{
  // When the left mouse button is pressed, record its postition and save it in corner1
  ...
  if(event == EVENT_LBUTTONUP)
  {
    ...
    {
      cout << "Plz select a bigger region" << endl;
      ldown = false;
    }
  }
...
int main() 
{
  ...
  setMouseCallback("Cropping", mouse_callback);
